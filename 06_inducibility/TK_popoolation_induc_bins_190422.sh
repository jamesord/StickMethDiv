...
#SBATCH --job-name="TK_popoolation_induc_bins_190422.sh"
...
--gtf pop_induc_bins_${i1}_190422.gtf --output ${i1}_temp.${k} --measure ${k}
...
cat *_induc_temp.div > pop_induc_bins_190422.div
rm *_temp.*
