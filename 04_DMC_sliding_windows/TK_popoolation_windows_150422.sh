...
#SBATCH --job-name="TK_popoolation_windows_150422.sh"
#SBATCH --time=10:00:00
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=100G

gunzip pop_results_windows_categories_150422.gtf.gz
...
--gtf pop_results_windows_categories_150422.gtf --output ${i1}_temp.${k} --measure ${k}
...
paste temp.pi <(cut -f 4 temp.theta) <(cut -f 4 temp.D) > pop_DMCs_steps_windows_150422.div

rm *.theta *.pi *.D *.params

gzip pop_results_windows_categories_150422.gtf